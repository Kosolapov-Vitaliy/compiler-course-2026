...
; CHECK:       %{{[0-9]+}} = call double @llvm.trunc.f64(double %div)
; CHECK:       %mul = fmul double %{{[0-9]+}}, %b
...
; CHECK:       %{{[0-9]+}} = call <2 x double> @llvm.trunc.v2f64(<2 x double> %div)
; CHECK:       %mul = fmul <2 x double> %{{[0-9]+}}, %b
